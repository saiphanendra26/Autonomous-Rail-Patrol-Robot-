...
![IR Sensor Distance Monitoring](./images/ir_sensor_distance_monitoring.png)

### 2. Robot – Top View
![Railway Track Inspection Robot - Top View](./images/rail_robot_top_view.jpg)

### 3. Robot Dashboard
![Railway Track Inspection Robot Dashboard](./images/railway_robot_dashboard.jpg)

### 4. Autonomous Maintenance Log
![Autonomous Maintenance Log](./images/autonomous_maintenance_log.png)

### 5. Robot – Side View
![Railway Track Inspection Robot - Side View](./images/rail_robot_side_view.jpg)

### 6. Robot – Front View
![Railway Track Inspection Robot - Front View](./images/rail_robot_front_view.jpg)

### 7. Real-time Alerts & Actions
![Real-time Alerts and Actions](./images/real_time_alerts_actions.png)

### 8. Robot – Track View
![Railway Track Inspection Robot - Track View](./images/rail_robot_track_view.jpg)

### 9. Robot – Additional View
![Railway Track Inspection Robot - Additional View](./images/rail_robot_additional_view.jpg)

### 10. IR Crack Detection
![IR Crack Detection](./images/ir_crack_detection.jpg)
